...
- Always Checking for ODD/EVEN rule and min/max restrictions
...
- OMNI SIDs added with all the same checks to facilitate non-RNAV aircraft and other abnormal departures.
# Limitations:
